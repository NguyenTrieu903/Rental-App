...
const PropertyTenants = () => {
  ...
  const getCurrentMonthPaymentStatus = useMemo(() => {
    return (leaseId: number) => {
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div>
              ...
              px-4 rounded-md flex items-center justify-center hover:bg-primary-700 hover:text-primary-50 cursor-pointer`}
              >
